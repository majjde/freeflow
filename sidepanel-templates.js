// ============================================================
// Empire - Side Panel Templates (Static/HTML)
...
function spTemplateLicenseGate() {
  return '<div class="sp-license-gate">' +
    ...
    '<p class="sp-gate-title">License Key Login</p>' +
    '<p class="sp-gate-desc">Enter your license key to unlock Freeflow. Email Admin - scoopwithpiper@gmail.com</p>' +
    '<input class="sp-input" id="sp-license-input" placeholder="Enter license key" spellcheck="false">' +
    '<button class="sp-btn-primary" id="sp-validate-btn">Login with License</button>' +
    '<div class="sp-log" id="sp-license-log"></div>' +
    '<div class="sp-contact-admin">Email Admin - scoopwithpiper@gmail.com</div>' +
  '</div>';
}
...
function spTemplateStatusBadge(status) {
  if (status === 'trial') {
    return '<span class="sp-status-badge sp-badge-test">PRO</span>';
  }
